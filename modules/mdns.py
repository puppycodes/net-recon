    ...
    def search(self):
        ...
        for session in sessions:
            ...
            for packet in sessions[session]:
                ...
                if packet.getlayer(IP) and packet.getlayer(UDP) and packet.getlayer(DNS) and packet[UDP].sport == 5353 and packet[UDP].dport == 5353 and packet[IP].dst == '224.0.0.251':
